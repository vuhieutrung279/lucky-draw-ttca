...
export const PRIZE_CONFIGS: PrizeConfig[] = [
  {
    ...
    productName: 'Pin sạc dự phòng Ugreen',
    productDetail: 'MagSafe Qi2 15W Fast Charge',
    count: 9,
    gridCols: 3,
  },
  {
    ...
    productDetail: 'Chủ Động Khử Tiếng Ồn (ANC)',
    count: 5,
    gridCols: 2,
  },
  {
  ...
  },
  {
    ...
    productDetail: 'Titanium Desert Edition',
    count: 1,
    gridCols: 1,
  },
];
